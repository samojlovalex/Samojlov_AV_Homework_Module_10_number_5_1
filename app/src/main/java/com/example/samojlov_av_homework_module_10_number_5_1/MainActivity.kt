...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var calculatorLaunchBTN: Button
...
//        setContentView(R.layout.activity_main)
    ...
    private fun init() {
        ...
        calculatorLaunchBTN = binding.calculatorLaunchBTN

        calculatorLaunchBTN.setOnClickListener {
...
//            startActivity(intent)
    ...
    private val launchCalculatorActivity = registerForActivityResult(
        ...
        if (result.resultCode == RESULT_OK) {
            ...
            val resultOut = data!!.getStringExtra("calculation")
            resultTV.text = resultOut
            Toast.makeText(this, "Результат: $resultOut", Toast.LENGTH_LONG).show()
        } else {
